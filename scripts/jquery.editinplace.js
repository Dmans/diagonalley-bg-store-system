...
$.fn.editInPlace.defaults = {
	...
	save_button:		'<button class="inplace_save">儲存</button>', // string: image button tag to use as “Save” button
	cancel_button:		'<button class="inplace_cancel">取消</button>', // string: image button tag to use as “Cancel” button
