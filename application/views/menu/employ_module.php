<div id="employ_area">
	...
	<div><a target="content" href="<?=site_url("employ/employ_action/list_form2/1/") ?>">上下班打卡(斜角巷)</a></div>
	<div><a target="content" href="<?=site_url("employ/employ_action/list_form2/2/") ?>">上下班打卡(貝克街)</a></div>
