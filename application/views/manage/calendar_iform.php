...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body class="container-fluid">
		<h1>新增行事曆</h1>
		<? echo form_open('manage/calendar_action/save'); ?>
			<div>日期:<input id="calDate" name="cal_date" type="text" value="<?php echo set_value('cal_date', ''); ?>"></div>
			<div>日期類型:
			...
			<div>日期說明:<input id="calDesc" name="cal_desc" type="text" value="<?php echo set_value('cal_desc', ''); ?>"></div>
			<?=validation_errors('<div class="text-danger">','</div>') ?>
			<div>
				<input type="submit" value="新增行事曆" class="btn btn-primary" />
